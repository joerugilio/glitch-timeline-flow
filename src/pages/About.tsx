...
const About = () => {
  ...
  const renderSkillBar = (skill: typeof skillCategories[0]['skills'][0]) => (
    ...
    <div className="min-h-screen bg-background">
      ...
      <main className="pt-16">
        ...
        <section className="px-4 py-16 bg-muted/30">
          <div className="max-w-4xl mx-auto">
            {biography.map((section, index) => (
              <div key={section.id} className={`mb-16 ${index % 2 === 1 ? 'lg:flex-row-reverse' : ''} lg:flex lg:gap-12 lg:items-center`}>
        ...
        <section className="px-4 py-16">
          <div className="max-w-6xl mx-auto">
            <h2 className="text-4xl font-light text-primary mb-12 text-center">Skills & Expertise</h2>
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
              {skillCategories.map((category) => (
                <Card key={category.name} className="hover-lift">
                  <CardHeader>
        ...
        <section className="px-4 py-16 bg-muted/30">
          <div className="max-w-6xl mx-auto">
            <h2 className="text-4xl font-light text-primary mb-12 text-center">Core Values</h2>
          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="grid md:grid-cols-3 gap-8">
              {interests.map((interest) => (
                <Card key={interest.title} className="overflow-hidden hover-lift">
                  {interest.image && (
