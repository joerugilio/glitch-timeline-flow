        ...
        <div className="pt-12 pb-4">
          <div className="w-full pt-4 px-4">
            ...
            <nav className="flex justify-between items-center mb-4">
              ...
              <Button asChild variant="outline" className="bg-slate-900 text-white border-slate-600 hover:bg-slate-800 hover:border-slate-500 transition-all font-semibold focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-slate-900 focus:outline-none">
              ...
              {nextPosition && <Button asChild variant="outline" className="bg-slate-900 text-white border-slate-600 hover:bg-slate-800 hover:border-slate-500 transition-all font-semibold focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-slate-900 focus:outline-none">
            ...
            <nav aria-label="Position navigation" className="mt-6 pt-3">
              <div className="flex justify-between items-center">
                {prevPosition ? <Button asChild variant="outline" className="bg-slate-900 text-white border-slate-600 hover:bg-slate-800 hover:border-slate-500 transition-all font-semibold focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-slate-900 focus:outline-none">
                ...
                {nextPosition ? <Button asChild variant="outline" className="bg-slate-900 text-white border-slate-600 hover:bg-slate-800 hover:border-slate-500 transition-all font-semibold focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-slate-900 focus:outline-none">
                  ...
                  </Button> : <Button asChild variant="outline" className="bg-slate-900 text-white border-slate-600 hover:bg-slate-800 hover:border-slate-500 transition-all font-semibold focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-slate-900 focus:outline-none">
