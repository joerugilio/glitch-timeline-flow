...
const PositionAccordion: React.FC<PositionAccordionProps> = ({ positions }) => {
  ...
  const [expandedAchievements, setExpandedAchievements] = useState<{ [positionId: string]: string[] }>({});
  ...
  const updateURL = (newExpandedPositions: string[], newExpandedAchievements: { [key: string]: string[] }) => {
  ...
  const handlePositionChange = (value: string[]) => {
    ...
    const newExpandedAchievements = { ...expandedAchievements };
          ...
          <div className="space-y-3 m-10">
            ...
            >
              {positions.map((position) => (
                ...
                >
                  <AccordionTrigger
                    className="bg-[#1b1f1b]/30 p-3 rounded-lg hover:bg-[#1b1f1b] hover:border-primary/30 data-[state=open]:bg-[#1b1f1b] data-[state=open]:border-primary/50 data-[state=open]:hover:border-primary/70 border border-transparent transition-all duration-300 hover:no-underline"
                    ...
                    <div className="backdrop-blur-xl px-4 py-4 rounded-sm space-y-6">
                      ...
                      <section className="px-4 py-4">
                        ...
                        <Accordion 
                          ...
                          onValueChange={(value) => handleAchievementChange(position.id, value)}
                        >
