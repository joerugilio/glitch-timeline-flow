      ...
      achievements: [
        {
          ...
          images: [
            {
              url: '/images/portfolio/principal-designer-tech/achievements/team-scaling-1.jpg',
              alt: 'International team collaboration meeting',
              caption: 'Cross-cultural design team collaboration'
            },
            {
              url: '/images/portfolio/principal-designer-tech/achievements/team-scaling-2.jpg',
              alt: 'Design team workspace',
              caption: 'Modern collaborative workspace design'
            },
            {
              url: '/images/portfolio/principal-designer-tech/achievements/team-scaling-3.jpg',
        ...
        },
        {
          ...
          images: [
            {
              url: '/images/portfolio/principal-designer-tech/achievements/design-to-code-1.jpg',
              alt: 'Code generation workflow',
              caption: 'Automated design-to-code pipeline'
            },
            {
              url: '/images/portfolio/principal-designer-tech/achievements/design-to-code-2.jpg',
        ...
        },
        {
          ...
          images: [
            {
              url: '/images/portfolio/principal-designer-tech/achievements/user-engagement-1.jpg',
              alt: 'User engagement analytics dashboard',
              caption: 'Real-time engagement metrics and analytics'
            },
            {
              url: '/images/portfolio/principal-designer-tech/achievements/user-engagement-2.jpg',
              alt: 'User interface redesign',
              caption: 'Before and after interface comparison'
            },
            {
              url: '/images/portfolio/principal-designer-tech/achievements/user-engagement-3.jpg',
              alt: 'User testing session',
              caption: 'Comprehensive user research and testing'
            },
            {
              url: '/images/portfolio/principal-designer-tech/achievements/user-engagement-4.jpg',
      ...
      achievements: [
        {
          ...
          images: [
            {
              url: '/images/portfolio/design-lead-fintech/achievements/transaction-platform-1.jpg',
              alt: 'Financial dashboard interface',
              caption: 'Real-time transaction monitoring dashboard'
            },
            {
              url: '/images/portfolio/design-lead-fintech/achievements/transaction-platform-2.jpg',
              alt: 'Data visualization',
              caption: 'Advanced financial data visualization'
            },
            {
              url: '/images/portfolio/design-lead-fintech/achievements/transaction-platform-3.jpg',
              alt: 'Platform architecture',
              caption: 'Scalable platform architecture design'
            },
            {
              url: '/images/portfolio/design-lead-fintech/achievements/transaction-platform-4.jpg',
              alt: 'Security features',
              caption: 'Enterprise security and compliance features'
            },
            {
              url: '/images/portfolio/design-lead-fintech/achievements/transaction-platform-5.jpg',
        ...
        },
        {
          ...
          images: [
            {
              url: '/images/portfolio/design-lead-fintech/achievements/onboarding-optimization-1.jpg',
              alt: 'User onboarding flow',
              caption: 'Streamlined onboarding user interface'
            },
            {
              url: '/images/portfolio/design-lead-fintech/achievements/onboarding-optimization-2.jpg',
        ...
        },
        {
          ...
          images: [
            {
              url: '/images/portfolio/design-lead-fintech/achievements/design-team-foundation-1.jpg',
              alt: 'Design team collaboration',
              caption: 'Collaborative design team environment'
            },
            {
              url: '/images/portfolio/design-lead-fintech/achievements/design-team-foundation-2.jpg',
              alt: 'Design process documentation',
              caption: 'Design process and methodology documentation'
            },
            {
              url: '/images/portfolio/design-lead-fintech/achievements/design-team-foundation-3.jpg',
              alt: 'Team workshops',
      ...
      achievements: [
        {
          ...
          images: [
            {
              url: '/images/portfolio/product-manager-startup/achievements/ipo-strategy-1.jpg',
        ...
        },
        {
          ...
          images: [
            {
              url: '/images/portfolio/product-manager-startup/achievements/user-growth-1.jpg',
              alt: 'User growth analytics',
              caption: 'Exponential user growth metrics'
            },
            {
              url: '/images/portfolio/product-manager-startup/achievements/user-growth-2.jpg',
        ...
        },
        {
          ...
          images: [
            {
              url: '/images/portfolio/product-manager-startup/achievements/pl-management-1.jpg',
      ...
      achievements: [
        {
          ...
          images: [
            {
              url: '/images/portfolio/ux-director-enterprise/achievements/accessibility-compliance-1.jpg',
        ...
        },
        {
          ...
          images: [
            {
              url: '/images/portfolio/ux-director-enterprise/achievements/international-team-1.jpg',
              alt: 'Global team collaboration',
              caption: 'International team coordination and collaboration'
            },
            {
              url: '/images/portfolio/ux-director-enterprise/achievements/international-team-2.jpg',
        ...
        },
        {
          ...
          images: [
            {
              url: '/images/portfolio/ux-director-enterprise/achievements/design-system-scale-1.jpg',
              alt: 'Design system documentation',
              caption: 'Comprehensive design system documentation'
            },
            {
              url: '/images/portfolio/ux-director-enterprise/achievements/design-system-scale-2.jpg',
      ...
      achievements: [
        {
          ...
          images: [
            {
              url: '/images/portfolio/product-designer-acquisition/achievements/user-growth-design-1.jpg',
        ...
        },
        {
          ...
          images: [
            {
              url: '/images/portfolio/product-designer-acquisition/achievements/acquisition-success-1.jpg',
              alt: 'Acquisition announcement',
              caption: 'Strategic acquisition milestone'
            },
            {
              url: '/images/portfolio/product-designer-acquisition/achievements/acquisition-success-2.jpg',
        ...
        },
        {
          ...
          images: [
            {
              url: '/images/portfolio/product-designer-acquisition/achievements/data-driven-design-1.jpg',
              alt: 'Data analytics dashboard',
              caption: 'Advanced design analytics and metrics tracking'
            },
            {
              url: '/images/portfolio/product-designer-acquisition/achievements/data-driven-design-2.jpg',
